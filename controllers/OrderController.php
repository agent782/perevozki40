            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['client'],
                        'allow' => true,
                        'roles' => ['client','car_owner']
                    ],
                    [
                        'actions' => ['vehicle', 'accept-order'],
                        'allow' => true,
                        'roles' => ['car_owner']
                    ],
                    [
                    ...
                    [
                        'actions' => ['finish-by-vehicle',  'canceled-by-vehicle' ],
                        'allow' => true,
                        'matchCallback' => function ($rule, $action) {
                            $get = Yii::$app->request->get();
                            $Order = Order::findOne($get['id_order']);
                            return
                                $Order->vehicle->id_user == Yii::$app->user->id;
                        }
                    ],
                    [
                        'actions' => ['canceled-by-client', 'update', 'view',],
                        'allow' => true,
                        'matchCallback' => function ($rule, $action) {
                            $get = Yii::$app->request->get();
                            $Order = Order::findOne($get['id_order']);
