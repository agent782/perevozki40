...
//            'tonnage_long_max' => SORT_ASC
    ...
    {
        $star = (Yii::$app->user->can('car_owner')) ? ' **' : '';
        return [
            'id' => 'ID',
            ...
            'r_km' => 'Руб/км (при пробеге более 120 км)' . $star,
            'h_loading' => 'Бесплатное время на погрузку/ разгрузку/ ожидание при пробеге >120км, ч.',
            'r_loading' => 'Переработка сверх бесплатного времени при пробеге >120км, руб/час' . $star,
            'min_price' => 'Мин. плата при пробеге >120км, руб.' . $star,
            'r_h' => 'Руб/час (при пробеге менее 120 км)' . $star,
            ...
            'remove_awning' => 'Растентовка (1 сторона), руб.' . $star,
            'status' => 'Статус',
