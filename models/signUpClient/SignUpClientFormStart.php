...
//            ['phone2', 'match', 'pattern' => '/^\+7\([0-9]{3}\)[0-9]{3}\-[0-9]{2}\-[0-9]{2}$/'],
    ...
    public function ValidateDataPassport(){
    ...
    public function saveProfile()
    {
        ...
        $modelProfile->id_passport = $this->passport_number;
