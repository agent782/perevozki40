...
<div class="order-form">
    ...
    <?= $form->field($model, 'id_pricezone_for_vehicle')->textInput() ?>
    ...
    <?= $form->field($model, 'cost_finish')->textInput() ?>

    <?= $form->field($model, 'cost_finish_vehicle')->textInput() ?>
    ...
    <?= $form->field($model, 'real_tonnage')->textInput() ?>

    <?= $form->field($model, 'real_length')->textInput() ?>

    <?= $form->field($model, 'real_volume')->textInput() ?>

    <?= $form->field($model, 'real_passengers')->textInput() ?>

    <?= $form->field($model, 'real_tonnage_spec')->textInput() ?>

    <?= $form->field($model, 'real_length_spec')->textInput() ?>

    <?= $form->field($model, 'real_volume_spec')->textInput() ?>

    <?= $form->field($model, 'real_h_loading')->textInput() ?>

    <?= $form->field($model, 'real_km')->textInput() ?>

    <?= $form->field($model, 'real_remove_awning')->textInput() ?>

    <?= $form->field($model, 'comment_vehicle')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'real_datetime_start')->textInput() ?>
