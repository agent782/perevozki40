...
<div class="order-search">
    ...
    <?php // echo $form->field($model, 'id_pricezone_for_vehicle') ?>
    ...
    <?php // echo $form->field($model, 'cost_finish') ?>

    <?php // echo $form->field($model, 'cost_finish_vehicle') ?>
    ...
    <?php // echo $form->field($model, 'real_h_loading') ?>

    <?php // echo $form->field($model, 'real_km') ?>

    <?php // echo $form->field($model, 'real_remove_awning') ?>

    <?php // echo $form->field($model, 'comment_vehicle') ?>

    <?php // echo $form->field($model, 'real_datetime_start') ?>
