...
<hr>
                ...
                <div id="typebody" hidden>
                    ...
                    <div id="size" hidden>
                        ...
                        <div id="dimensions" style="display: none;">
                            <?= $form->field($order, 'longer',['inputOptions' => ['id'=>'length']])->hint('Длинна')->label(false);?>
                            <?= $form->field($order, 'width',['inputOptions' => ['id'=>'width']])->hint('Ширина')->label(false); ?>
                            <?= $form->field($order, 'height',['inputOptions' => ['id'=>'height']])->hint('Высота')->label(false); ?>
                        </div>
                        ...
                        <div id="volume" style="display: none;">
                            <?= $form->field($order, 'volume',['inputOptions' => ['id'=>'volume']])->hint('Объем')->label(false);?>
    ...
    <div id="route" hidden >
        ...
        <?= $form->field($route, 'distance', ['inputOptions' => ['id'=>'lengthRoute']])->label(false)->hiddenInput();?>
        <br>
...
<?php ActiveForm::end(); ?>
<hr>
<button id="testBut">Knopka</button>
